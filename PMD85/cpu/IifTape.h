...
class IifTape : public PeripheralDevice, public ChipUSART8251 {
  public:
    IifTape (const BYTE portAddr, const BYTE portMask, const bool needReset);
...
*/
    void OnRtsSet () override {
      FnOnRtsSet();
    }
    void OnTxRChange () override {
      FnOnTxRChange();
    }

    virtual void TapeCommand (int, bool*) {};
    virtual void PrepareSample (int, bool, int) {};
