...
class ChipUSART8251 {
  public:
    ...
    virtual void   OnTxDChange () {};
    virtual void   OnTxRChange () {};
    virtual void   OnTxEChange () {};
    virtual void   OnRxRChange () {};
    virtual void   OnDtrChange () {};
    virtual void   OnRtsChange () {};
    virtual void   OnSynDetChange () {};
    virtual void   OnBrkDetChange () {};

    virtual void   OnTxDSet () {};
    virtual void   OnTxRSet () {};
    virtual void   OnTxESet () {};
    virtual void   OnRxRSet () {};
    virtual void   OnDtrSet () {};
    virtual void   OnRtsSet () {};
    virtual void   OnSynDetSet () {};
    virtual void   OnBrkDetSet () {};
    /*
