...
class ChipCpu8080 { /*: public sigslot::has_slots<>*/
  public:
    ...
    // virtual ~ChipCpu8080(); // staticka instance nebude destruktor potrebovat
  ...
  private:
    ...
    struct PORT_HANDLER {
      ...
      PORT_HANDLER     * next;    // pointer to next list item
      // void Destroy () {};
    };
    */
    PeripheralDevice * device;  // pointer to device object
...
// members to share with children implementations...
    ...
    static const char duration[256];       // instruction durations
