...
/**
  ...
  * @brief Skupina pinů.
  * 
  * Používá se většinou jen pro alternativní funkce v periferiích.
  * Bývá to jednodušší, pokud je pinů víc (SPI, USART, ADC ...) a jsou na stejném portu a mají stejné AFn.
 * */
class GpioGroup {
  public:
